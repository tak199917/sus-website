  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-28 bg-white overflow-hidden">
      <div className="section-container">
        ...
        {/* School Name Section */}
        <div 
          className={`bg-gradient-to-br from-[#00457c] to-[#002a5c] rounded-2xl p-8 md:p-12 mb-16 text-white transition-all duration-700 delay-100 ${
        ...
        <div className="mb-16">
          <h3 
            className={`text-2xl font-semibold text-[#00457c] mb-8 text-center font-['Fraunces'] transition-all duration-700 delay-200 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {logoElements.map((element, index) => {
              ...
              return (
                <div
                  key={element.title}
                  className={`group relative bg-white rounded-2xl border border-gray-100 shadow-lg p-8 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 ${
                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                  }`}
        ...
        {/* Tri-color Section */}
        <div 
          className={`bg-[#f8fafc] rounded-2xl p-8 md:p-12 mb-16 transition-all duration-700 delay-500 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}
        >
...
>{color.meaning}</p>
        ...
        {/* Motto Section */}
        <div 
          className={`bg-gradient-to-r from-amber-50 via-orange-50 to-amber-50 rounded-2xl p-8 md:p-12 mb-16 border border-amber-100 transition-all duration-700 delay-600 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}
        >
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div 
            className={`bg-white rounded-2xl border border-gray-100 shadow-lg p-8 transition-all duration-700 delay-700 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}
          >
          ...
          <div 
            className={`bg-gradient-to-br from-[#00457c] to-[#002a5c] rounded-2xl p-8 text-white transition-all duration-700 delay-800 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}
          >
...
/>
                ...
                <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden shadow-md border-4 border-[#f36b25] flex items-center justify-center bg-white">
  {member.photo ? (
    <img
      src={member.photo}
      alt={member.name}
    ...
    <Users className="w-10 h-10 text-[#00457c]" />
  )}
</div>

                <h4 className="font-semibold text-gray-900 font-['Fraunces']">{member.name}</h4>
                <span
